...
JARVIS = {
    ...
    "system_prompt": (
        ...
        "- coding_session — to actually DO something on the user's machine (write or change "
        "code, build or run a script, set things up), spawn a Claude Code session locally; it "
        "does the work and returns what it did. For any 'build/run/code/set up/do X' request, "
        "use this directly — don't just describe the steps, perform them.\n\n"
